...
Modified by William Anderson 2023 for application to RONS
...
WriteMatlabMEXP::usage =
"Write metric tensor when using Gaussian approximate solution"

WriteMatlabFEXP::usage =
"Write RHS vector when using Gaussian approximate solution"

WriteMatlabFRHS::usage =
...
WriteMatlabM[e_,qstring_,pdename_,file_OutputStream] :=
    (WriteString[file, StringJoin["function M = Mblock_",pdename,"(q) \n\n",qstring,"\n\nM = ", ToMatlab[e]]];)
    
WriteMatlabF[e_,nonlinval_,qinputs_,qstring_,params_,pdename_,file_OutputStream] :=
    (WriteString[file, StringJoin["function F = F",nonlinval,"block_",pdename,"(",qinputs,",r,param1,",params,")\n\n",qstring,"\n\nF = ", ToMatlab[e]]];)
    

WriteMatlabMEXP[e_,qstring_,prod_,centerstring_,acs_,pdename_,file_OutputStream] :=
    (WriteString[file, StringJoin["function M = Mblock_",pdename,"(q) \n\n",qstring,"\n\nc = ",ToMatlab[Exp[prod]],
    "\n",centerstring,"a = ",ToMatlab[-acs],"\nM = ", ToMatlab[e]]];)
    
(*WriteMatlabFEXP[e_,nonlinval_,qinputs_,qstring_,params_,prod_,centerstring_,acs_,pdename_,file_OutputStream] :=
    (WriteString[file, StringJoin["function F = F",nonlinval,"block_",pdename,"(",qinputs,",r,param1,",params,")\n\n",qstring,"\n\nc = ",ToMatlab[Exp[prod]],
    "\n",centerstring,"a = ",ToMatlab[-acs],"\nF = ", ToMatlab[e]]];)*)
...
WriteMatlabFRHS[e_,file_OutputStream] :=
    (WriteString[file, e];)
