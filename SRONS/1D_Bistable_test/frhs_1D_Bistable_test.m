function dqdt = frhs_1D_Bistable_test(t,q,r,param1,delta,alpha1,alpha2,alpha3,nu)
...
for k = 1:r
	f((1:param1) + param1*(k-1)) = ...
		F0block_1D_Bistable_test(qk(k,:),q,r,param1,alpha1,alpha2,alpha3,nu);
end
