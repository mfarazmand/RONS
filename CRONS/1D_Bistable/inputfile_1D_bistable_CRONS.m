...
dt1 = 0.1;
dt2 = 2.5;
t = [t0 :dt1:ts - dt1,  ts:dt2:tf];


% rhs function
F = @(t, q)(frhs_1D_bistable(t, q,r,param1,samples,delta,alpha1,alpha2,alpha3,nu));
...
%% Analytical equilibrium for comparison
